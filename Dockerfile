FROM python:3.7.4-alpine3.8 AS requirements
ADD . /app
WORKDIR /app
...
FROM python:3.7.4-alpine3.8 AS runtime-pips
...
FROM python:3.7.4-alpine3.8 AS pytest
